...
public class MedicineStockinfoController { 
    ...
    public String list(Model model) throws IOException { 
        List<MedicineStockinfo> list = medicineStockinfoService.find();
    ...
    public void ajaxLoad(HttpServletResponse response,int codeId) throws IOException {
        MedicineStockinfo byId = medicineStockinfoService.findByCodeId(codeId);
