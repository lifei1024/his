...
public class DoctorVisitRecordServiceImpl  implements IDoctorVisitRecordService {
    ...
    @Override
    public DoctorVisitRecord findSort() {
        List<DoctorVisitRecord> list = dao.findSort();
        return list.get(0);
    }

    @Override
    public void updateReId(Integer registerId) {
        dao.updateReId(registerId);
    }

    @Override
    public List<DoctorVisitRecord> findByPid(Integer patientId) {
